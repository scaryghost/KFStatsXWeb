...
$columns= array("level", "difficulty", "length", "result", "wave", "timestamp");
...
$file= 'http://127.0.0.1:8080/sessions.xml?steamid64=' . $_REQUEST["steamid64"] . '&page=' . $query[0] . '&rows=' . $query[1] . $order;
